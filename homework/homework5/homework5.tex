...
\begin{align*}
V_{GS}-V_{TN}&=\frac{1}{K_nR_s}\left(\sqrt{1-2K_nR_sV_{TN}}-1\right)\\
&=\frac{1}{2\cdot0.3\unit{A/V^2}\cdot9\unit{k\Omega}}\left(\sqrt{1-2\cdot0.3\unit{A/V^2}\cdot9\unit{k\Omega}\cdot-3\unit{V}}-1\right)\\
&=0.023\unit{V}<V_{DS}
\end{align*}

So the $Q$ point is $(0.33\unit{mA},\ 0.023\unit{V})$, and it is in the saturated region.
